            ...
            <div class="container overlay-container">
              <figure class="image">
                ...
                <img
                  ...
                  class="image-preview profile_image"
                  v-if="
                    profile_image && modify_profile && !profile_image_preview
                  "
                />
                <img
...
export default {
  ...
  data() {
    return {
      ...
      business_type: '',
      options: [
        { title: "โฆษณา / ประชาสัมพันธ์" },
        { title: "เกษตรกรรม / ป่าไม้" },
        { title: "สายการบิน" },
        { title: "ความงาม / เครื่องสำอางค์" },
        { title: "เครื่องดื่ม / อาหาร / ภัตตาคาร" },
        { title: "อุตสาหกรรมการท่องเที่ยว" },
        { title: "องค์กรการกุศล" },
        { title: "เคมีภัณฑ์ / ปิโตรเคมีภัณฑ์" },
        { title: "เสื้อผ้า / รองเท้า / เครื่องตกแต่ง" },
        { title: "การก่อสร้าง / การตกแต่ง" },
        { title: "สินค้าอุปโภค / บริโภค" },
        { title: "บริการพาณิชย์อิเล็กทรอนิกส์" },
        { title: "การศึกษา" },
        { title: "อิเล็คโทรนิกส์ / เครื่องใช้ไฟฟ้า" },
        { title: "เครื่องจักร" },
        { title: "การเงิน / การธนาคาร / หลักทรัพย์" },
        { title: "เฟอร์นิเจอร์" },
        { title: "หน่วยงานรัฐบาล" },
        { title: "กราฟฟิก ดีไซน์" },
        { title: "โรงพยาบาล" },
        { title: "โรงแรม / รีสอร์ท" },
        { title: "ทรัพยากรบุคคล" },
        { title: "ไอที - ฮาร์ดแวร์" },
        { title: "ไอที - ซอฟต์แวร์ / โทรคมนาคม" },
        { title: "อัญมณี / เครื่องประดับ" },
        { title: "กฎหมาย / ที่ปรึกษาทางธุรกิจ" },
        { title: "การผลิต" },
        { title: "การตลาด" },
        { title: "การท่องเที่ยว" },
        { title: "กีฬา / นันทนาการ" },
        { title: "อื่นๆ" },
      ],
    };
  },
  ...
  methods: {
      ...
      axios
        ...
        .then((res) => {
          ...
          if (user[0].cover_image) {
            this.cover_image = user[0].cover_image
              .replace(/\\/g, "/")
              .replace("static", "");
          }
    ...
    saveProfile() {
      const businessTypeString = JSON.stringify(selectedBusinessType);
      const token = localStorage.getItem("token");
      const config = {
        headers: {
          Authorization: `Bearer ${token}`,
